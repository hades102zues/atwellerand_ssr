                ...
                <div className={styles.companyDescribe}>
                    ...
                    <article className={styles.companyDescribe__companyDescription}>
                        <p className={styles.description}>
                            Our Goal is to make our client's life more rewarding by giving them back the most precious asset there is -
                            TIME, which can be lost dealing with the hassles of life.
                        </p>
                    </article>
                </div>
            </div>
