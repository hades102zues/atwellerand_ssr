        ...
        <section className={`${styles.sec_padding} ${styles.sec_grey}`}>
            <div className={styles.wrapper}>
                ...
                <div className={styles.services_space}>
                    <div className={styles.services_box}>{serviceCards}</div>
                </div>
            </div>
        </section>
    );
