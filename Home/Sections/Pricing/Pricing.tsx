...
const pricing: React.FC = () => {
    ...
    const simplePlanOutput: JSX.Element[] = planStructure.map((config: Plan, index: number) => (
        ...
        <section className={`${styles.sec_padding} ${styles.sec_grey}`}>
            <div className={styles.wrapper}>
                ...
                <p className={styles.princing_sec_desc}>
                    Our prices are determined by our assessment of market forces. It is by the hour or part thereof with no additional fees
                    (e.g mileage & AC fees). What we charge benefits our client and earns us a profit and is discounted compared to global
                    rates.
                </p>
                    ...
                    <div className={styles.plan_box}>
                        <article className={styles.plan}>
                            ...
                            <div className={styles.day_space}>
                                ...
                                <p className={styles.disclaimer}>Note that errands booked after 5pm will be billed at $30.</p>
                                <p className={styles.disclaimer}>Rates are billed per hour or part thereof.</p>
                            </div>
                        </article>
                            ...
                            <div className={styles.day_space}>
                                <div className={styles.day_box}>
                                    ...
                                    <div className={styles.day_info}>
                                        ...
                                        <p style={{ color: "red" }}>Calculated Upon Client Request</p>
                                    </div>
                                </div>
                            </div>
                        </article>
